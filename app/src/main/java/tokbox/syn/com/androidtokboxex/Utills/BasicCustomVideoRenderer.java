package tokbox.syn.com.androidtokboxex.Utills;
    ...
    static class MyRenderer implements GLSurfaceView.Renderer {
        ...
        public void displayFrame(Frame frame) {
            ...
            if (mCustomVideoRenderer.mSaveScreenshot) {
                ...
                try {
                    //meeting_id_image1_dd-mm-yy_hh:mm:ss
                    Date now = new Date();
                    android.text.format.DateFormat.format("yyyy-MM-dd_hh:mm:ss", now);
                    String path = Environment.getExternalStorageDirectory().toString() + "/" + imageName + ".jpg";

//                    String path = Environment.getExternalStorageDirectory().toString();
//                    File myDir = new File(path + "/opentalk_images");
//                    if (!myDir.exists()) {
//                        myDir.mkdirs();
//                    }
                    OutputStream fOutputStream = null;
//                    File file = new File(myDir, "opentok-capture-" + System.currentTimeMillis() + ".png");
